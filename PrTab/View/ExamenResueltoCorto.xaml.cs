...
{
    public partial class ExamenResueltoCorto : PhoneApplicationPage
    {

        ExamenResueltoCortaViewModel _viewModel;

        public ExamenResueltoCorto()
        {
            InitializeComponent();
        ...
        {
            _viewModel = new ExamenResueltoCortaViewModel();
